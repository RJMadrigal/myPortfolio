    ...
    return(
        ...
        <div className='container about-page'>
           <div className='text-zone'>
            ...
            <p> I’m very ambitious developer looking for a role in
            established IT company with the opportunity to work with the latest
            technologies on challenging and diverse projects.</p>
            <p>
            I'm quietly confident, naturally curious, and perpetually working on
            improving my chops one design problem at a time. Knowledge of agile methodologies such as Scrum and data management.
          </p>
            <p>
            ...
            <p>
            Teck Stack : .NET, C#, VB, Java, JS, Python, SQL, React, HTML, CSS and more...
          </p>
           </div>
